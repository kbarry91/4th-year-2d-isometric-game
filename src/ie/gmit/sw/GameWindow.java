...
public class GameWindow {
	...
	private ObjectSprite[][] objects = {
			{ SpriteFactory.blankInstance(), SpriteFactory.blankInstance(), SpriteFactory.blankInstance(),
					SpriteFactory.treeInstance(), SpriteFactory.treeInstance(), SpriteFactory.treeInstance(),
					SpriteFactory.treeInstance(), SpriteFactory.treeInstance(), SpriteFactory.treeInstance(),
					SpriteFactory.blankInstance() },
			{ SpriteFactory.treeInstance(), SpriteFactory.chestInstance(), SpriteFactory.blankInstance(),
					SpriteFactory.blankInstance(), SpriteFactory.treeInstance(), SpriteFactory.treeInstance(),
					SpriteFactory.treeInstance(), SpriteFactory.treeInstance(), SpriteFactory.treeInstance(),
					SpriteFactory.blankInstance() },
			{ SpriteFactory.treeInstance(), SpriteFactory.treeInstance(), SpriteFactory.blankInstance(),
					SpriteFactory.blankInstance(), SpriteFactory.blankInstance(), SpriteFactory.treeInstance(),
					SpriteFactory.treeInstance(), SpriteFactory.treeInstance(), SpriteFactory.treeInstance(),
			...
			{ SpriteFactory.blankInstance(), SpriteFactory.blankInstance(), SpriteFactory.blankInstance(),
					SpriteFactory.blankInstance(), SpriteFactory.blankInstance(), SpriteFactory.blankInstance(),
					SpriteFactory.blankInstance(), SpriteFactory.chestInstance(), SpriteFactory.treeInstance(),
					SpriteFactory.blankInstance() },
			{ SpriteFactory.blankInstance(), SpriteFactory.blankInstance(), SpriteFactory.blankInstance(),
					SpriteFactory.blankInstance(), SpriteFactory.blankInstance(), SpriteFactory.chestInstance(),
					SpriteFactory.blankInstance(), SpriteFactory.blankInstance(), SpriteFactory.blankInstance(),
					SpriteFactory.blankInstance() },
			{ SpriteFactory.blankInstance(), SpriteFactory.blankInstance(), SpriteFactory.blankInstance(),
					SpriteFactory.blankInstance(), SpriteFactory.blankInstance(), SpriteFactory.blankInstance(),
